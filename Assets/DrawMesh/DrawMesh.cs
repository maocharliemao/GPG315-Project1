    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            if (Vector3.Distance(currentMousePosition, lastMousePosition) > minDistance)
            {
                ...
                Vector3 newVertexUp =
                    currentMousePosition + Vector3.Cross(mouseForwardVector, normal2D) * lineThickness;
                Vector3 newVertexDown = currentMousePosition +
                                        Vector3.Cross(mouseForwardVector, normal2D * -1f) * lineThickness;
